...
# Shorter window for local testnet (miner uses localhost S3 API).
LOCAL_TESTNET_EVAL_PERIOD = dt.timedelta(minutes=5)

# Minimum on-demand job TTL (minutes) on local testnet. Miner rejects jobs with <5s left.
MIN_OD_TTL_MINUTES = 1
